...
--4.SELECT app_name, reviews FROM analytics GROUP BY app_name, reviews ORDER BY reviews DESC LIMIT 5;
...
--10.SELECT *  FROM analytics WHERE price > 0.10 AND price < 1.00 ORDER BY reviews DESC LIMIT 10;
--11. SELECT * FROM analytics ORDER BY last_updated LIMIT 1;
--12. SELECT * FROM analytics ORDER BY price LIMIT 1;
